...
#[derive(Debug)]
pub struct SmartDigitalProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SmartDigitalProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SmartDigital processing");
    
    let mut processor = SmartDigitalProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SmartDigitalProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SmartDigitalProcessor::new(false);
